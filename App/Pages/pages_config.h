...
typedef enum {
    ...
    PAGE_APP_FLASHLIGHT,
    PAGE_APP_SETTINGS,
    /* Heart rate & SpO2 standalone apps */
    PAGE_APP_HEARTRATE,
    PAGE_APP_HEARTRATE_DETAIL,
    PAGE_APP_SPO2,
    PAGE_APP_SPO2_DETAIL,
    PAGE_APP_ACTIVITY_DETAIL,
    PAGE_APP_ENVIRONMENT_DETAIL,
    PAGE_APP_ENVIRONMENT_PRESSURE_DETAIL,
    PAGE_COUNT
} page_id_t;
