...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LCD_CS_Pin|LCD_RST_Pin|TOUCH_RST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : TOUCH_INT_Pin RTC_INT_Pin KEY2_Pin */
  GPIO_InitStruct.Pin = TOUCH_INT_Pin|RTC_INT_Pin|KEY2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : IMU_INT1_Pin HR_INT_Pin */
  GPIO_InitStruct.Pin = IMU_INT1_Pin|HR_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
