 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --font C:/Windows/Fonts/CascadiaMono.ttf --format lvgl --bpp 1 --size 16 --range 0x20-0x7F -o e:/XiYangWatch/XiYang_Watch/Middlewares/LVGL/fonts/cascadia_mono_16.c
 ******************************************************************************/
...
#ifndef CASCADIA_MONO_16
#define CASCADIA_MONO_16 1
#endif
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t cascadia_mono_16 = {
#else
lv_font_t cascadia_mono_16 = {
#endif
